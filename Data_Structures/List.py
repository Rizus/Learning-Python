...
Список(List) создается в Python путем размещения элементов внутри [], разделенных запятыми.
...
!~Списки Python изменяемые. Списки значений могут быть изменены. И мы можем изменить элементы списка, назначив новые значения, используя = оператор.
